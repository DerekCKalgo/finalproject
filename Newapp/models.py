...
class Comment(models.Model):
    ...
    user_who_comment = models.ForeignKey(Register, related_name="comments", on_delete=models.CASCADE)
    photos = models.ManyToManyField(Photo, related_name="photo_comments")
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)